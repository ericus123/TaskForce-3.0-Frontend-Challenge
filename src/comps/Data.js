        ...
        <Container className="data">
            ...
            <Row className="data-row-2 justify-content-center">
                ...
                {vaccineCountryData?.timeline ? 
                    <Col className="data-col m-auto">
                        <h1>{vaccineCountryData?.timeline[vaccineCountryData?.timeline.length -1].daily || "-"}</h1>
                        <span>Vaccinated</span>
                        <h3>{vaccineCountryData?.timeline[vaccineCountryData?.timeline.length -1].total || "-"}</h3>
                    </Col> : null
                }
